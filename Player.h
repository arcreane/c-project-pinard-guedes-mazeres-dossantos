...
public:
    Player(uint16_t xPos, uint16_t yPos, Texture2D sprite, float speed);

    Player(uint16_t xPos, uint16_t yPos, Texture2D sprite, float speed, Texture2D textureForBullets, float delay);
